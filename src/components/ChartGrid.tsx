...
// 블루 계통 색상 팔레트 (톤 다운 + 명도 차이로 가시성 확보)
// - 채도는 낮추고(과하게 쨍하지 않게)
// - 밝기(L%)를 넓게 분산시켜 조각 간 구분을 강화
const COLORS = [
  'hsl(214, 38%, 24%)', // 딥 네이비
  'hsl(212, 44%, 34%)', // 딥 블루
  'hsl(206, 42%, 44%)', // 블루
  'hsl(199, 40%, 54%)', // 스카이 블루(톤다운)
  'hsl(193, 36%, 62%)', // 라이트 블루(톤다운)
  'hsl(225, 34%, 62%)', // 퍼플 블루(톤다운)
  'hsl(210, 30%, 72%)', // 페일 블루
  'hsl(202, 28%, 80%)', // 매우 옅은 블루
];
