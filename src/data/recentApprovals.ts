...
// 2025년 12월 1일 ~ 2026년 2월 27일 항암제 승인 현황 (공공데이터 API + 추가 조사 기반)
export const recentApprovals: ExtendedDrugApproval[] = [
  {
    ...
    company: '한국아스텔라스제약(주)',
    indication: 'CLDN18.2 양성, HER2 음성의 절제 불가능한 국소 진행성 또는 전이성 위선암 또는 위식도 접합부 선암 1차 치료(화학요법 병용)',
    cancerType: '위암',
    ...
    drugCategory: '전문의약품(희귀)',
    manufactureType: '수입',
    notes: 'CLDN18.2 표적 단클론항체, 표적항암제',
  },
  {
    id: '202600609',
    ...
    company: '(주)보령',
    indication: '필라델피아 염색체 양성 만성골수성백혈병(Ph+ CML) 및 급성 림프구성 백혈병(Ph+ ALL) 치료',
    cancerType: '만성골수성백혈병',
    approvalDate: '2026-02-27',
    status: 'approved',
  ...
  },
  {
    ...
    company: '한국릴리(유)',
    indication: 'ESR1 변이를 동반한 ER-양성, HER2-음성 진행성 또는 전이성 유방암 치료',
    cancerType: '유방암',
