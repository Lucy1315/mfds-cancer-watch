...
export const recentApprovals: ExtendedDrugApproval[] = [
  {
    ...
    company: '한국다이이찌산쿄(주)',
    indication: 'FLT3-ITD 변이 양성 새롭게 진단된 급성골수성백혈병(Acute Myeloid Leukemia, AML) 성인 환자의 치료',
    cancerType: '급성골수성백혈병',
  ...
  {
    id: '202600116',
    drugName: '보라니고정10밀리그램(보라시데닙)',
    genericName: '보라시데닙 (Vorasidenib)',
    company: '한국세르비에(주)',
    indication: 'IDH1 또는 IDH2 변이를 가진 2등급 신경교종(교모세포종 포함) 성인 환자의 치료',
    cancerType: '뇌종양(신경교종)',
    approvalDate: '2026-01-26',
    status: 'approved',
  ...
  {
    id: '202600049',
    drugName: '엔잘루타엔질캡슐40밀리그램(엔잘루타미드)',
